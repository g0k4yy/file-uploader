# -*- coding: utf-8 -*-
# FileUploadHelper.py - Burp Suite Jython 2.7 Extension
# Right-click on any request in Repeater/Proxy -> Extensions -> File Upload Helper
...
class ReplaceDialog(JDialog):
    ...
    def __init__(self, parent_frame, selected_text):
        JDialog.__init__(self, parent_frame, u"File Upload Helper", True)
...
class BurpExtender(IBurpExtender, IContextMenuFactory):
    ...
    def registerExtenderCallbacks(self, callbacks):
        ...
        callbacks.setExtensionName(u"File Upload Helper")
        callbacks.registerContextMenuFactory(self)
        print(u"[*] File Upload Helper loaded.")
        print(u"[*] Right-click any request in Repeater or Intruder -> Extensions -> File Upload Helper")
    ...
    def createMenuItems(self, invocation):
        ...
        if tool not in SUPPORTED:
            return None
        items = ArrayList()
        item  = JMenuItem(u"File Upload Helper")
